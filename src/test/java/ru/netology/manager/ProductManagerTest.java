...
class ProductManagerTest {
    ...
    Product product6 = new Smartphone(6, "Sixth", 600, "SSixth");
    Product product7 = new Smartphone(7, "Seventh", 700, "SSeventh");
    Product product8 = new Smartphone(8, "Eighth", 800, "SEigth");
    Product product9 = new Smartphone(9, "Ninth", 900, "SNinth");
    Product product10 = new Smartphone(10, "Tenth", 1000, "STenth");
